...
\begin{example}
  ...
  \begin{figure}[!ht]
    ...
    \begin{tikzpicture}[scale=0.7,>=stealth]
      \shade[ball color=orange] (0,0) circle (.3) node[below=3mm] {$q_1$};
      \shade[ball color=orange] (3,2) circle (.3) node[above=3mm] {$q_2$};
      \draw[dotted] (0,0) -- (3,2);
      \draw[thick,cyan!80!black] (3,2) circle (1pt);
      \draw[thick,cyan!80!black,->] (3,2) -- (4,2.67) node[above right] {$\vec{F}_{21}$}; 
    \end{tikzpicture}
    \caption{}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\textwidth]{coulomb_force.pdf}
