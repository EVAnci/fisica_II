...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    ...
    \begin{tikzpicture}[>=stealth]
      ...
      \draw[->,thin] (0,-.2) -- (0,\l) node[left] {$y$};
      \shade[ball color=orange] (2,\l/2) circle (.2) node[above=2mm] {$q$};
    \end{tikzpicture}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    ...
    \begin{tikzpicture}[>=stealth]
      ...
      \draw[->,thin] (-.2,0) -- (4,0) node[right] {$x$};
      \draw[->,thin] (0,-.2) -- (0,\l) node[left] {$y$};
      \draw[very thick,->] (2,\l/2) -- (3,\l/2) node[right] {$F_e$};
      \shade[ball color=orange] (2,\l/2) circle (.2) node[above=2mm] {$q$};
      \shade[inner color=white,outer color=red!70!black!70] (0.1,0.1) rectangle (.3,\l-.1);
      \shade[inner color=white,outer color=blue!60!black!60] (3.7,0.1) rectangle (3.9,\l-.1);
    \end{tikzpicture}
...
\begin{marginfigure}
  ...
  \end{tikzpicture}
  \caption{Diagrama de cuerpo libre con la condición de equilibrio.}
...
\begin{itemize}
  ...
  \item \( Q \): carga total del cuerpo lineal,
...
\begin{itemize}
  ...
  \item \( Q \): carga de la superficie completa,
...
\begin{itemize}
  ...
  \item \( Q \): carga del volumen total,
...
\begin{example}
  ...
  \begin{figure}[!ht]
    ...
    \begin{tikzpicture}[>=stealth]
      ...
      \draw[thin,->] (0,-.5) -- (0,1.5) node[above right] {$y$};
  ...
  \end{gather*}
  Como se ha realizado el cálculo empleando el lado negativo del eje de abscisas, entonces la última expresión espera valores de \(\ell\) y \(a\) negativos. En general, esta expresión se presentará para colocar valores de \(\ell\) y \(a\) positivos (ya que en general una distancia no se considera negativa). De esta manera, puede alternar el signo resultante para obtener la expresión final, donde resulta
  \[
    \boxed{F_{qQ} = k_e\frac{\ell \lambda q}{2a(\ell+2a)}}
  \]
  Esta manipulación de signos se debe a que solo se ha trabajado con cantidades escalares, y el carácter vectorial se ha impuesto.
\end{example}
