...
Teniendo en cuenta la definición de potencial (ecuación \eqref{eq:potential}) la diferencia de potencial \(\Delta V = V_B - V_A\) entre dos puntos \(A\) y \(B\) en un campo eléctrico se define como el cambio en energía potencial por unidad de carga al mover una carga de prueba \(q\) entre esos dos puntos
\begin{equation}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.75\textwidth]{potential_const_field.png}
...
\subsection{Potencial eléctrico debido a una carga puntual}

Como se menciona en la definición, la energía potencial es relativa al punto que se ha definido como punto de potencial cero. Con el potencial eléctrico pasa lo mismo, entonces si se quiere saber el potencial en un punto \(P\) del campo eléctrico, sabe que es igual al trabajo realizado por la fuerza eléctrica al mover una carga de prueba \(q\), pero ¿Desde donde hasta donde? Bueno, se puede definir que el potencial sea cero cuando la carga \(q\) esté infinitamente alejada de la fuente. Entonces el potencial en el punto \(P\) es el trabajo requerido para mover la carga de prueba desde el infinito hasta el punto \(P\),
\begin{marginfigure}
    \centering
