...
La ecuación \eqref{eq_gradiente_de_potencial} también se puede interpretar de una forma mucho más intuitiva. Esta expresión establece que si no hay una variación de potencial eléctrico, el campo eléctrico es constante. Esto significa que, siempre que se mantenga sobre una superficie equipotencial, donde la diferencia de potencial es cero, la magnitud del campo no cambiará.
