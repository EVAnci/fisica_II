\begin{tcolorbox}[resumen,title=Corriente Eléctrica]
...
\begin{tcolorbox}[resumen,title=Ley de Ohm]
...
\begin{tcolorbox}[resumen,title=Circuitos]
  \subparagraph{Serie:}
  \begin{itemize}
...
\begin{tcolorbox}[resumen,title=Trabajo y Potencia eléctrica]
