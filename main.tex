...
\begin{document}
  ...
  \begin{titlepage}
    ...
    {\LARGE Universidad de Mendoza \par}
    \vspace{3.5cm}
  ...
  \include{chapters/1_electrostatic/main}
  
  \include{chapters/2_direct_current/main}

  % \include{chapters/3_electromagnetism/main}

  % \include{chapters/4_waves_and_vibrations/main}

  % \include{chapters/5_optics/main}

  % \include{chapters/6_intro_of_fluids/main}

  % \include{chapters/7_dynamic_of_fluids/main}

  % \include{chapters/8_heat_and_temperature/main}

  % \include{chapters/9_reminders/main}
